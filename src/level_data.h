/*
 * Generated by recovered/analysis/DumpRoomData.csx from the recovered data.win.
 * Rooms are listed in the original runtime order (GeneralInfo.RoomOrder),
 * so room 0 is the GameMaker start room and room_goto_next() follows the array.
 * Instances are in stored creation order with their instance-layer depth.
 */
#ifndef LONGO_DOGGO_LEVEL_DATA_H
#define LONGO_DOGGO_LEVEL_DATA_H

/* GameMaker object_index values recovered from data.win.  The numeric order
 * matches the original asset table (oMouse's editor palette depends on it). */
enum LongoObj {
    LONGO_BLOOM = 0,
    LONGO_OBJ_SKULL = 1,
...
typedef struct LongoRoomInstance {
    unsigned char object;
    float x;
    float y;
    float xscale;
    float yscale;
    int depth; /* depth of the instance layer it was placed on */
} LongoRoomInstance;
...
typedef struct LongoRoom {
    ...
    int width;
    int height;
    const LongoRoomInstance *instances;
    int instance_count;
} LongoRoom;

#define LONGO_ROOM_COUNT 11

static const LongoRoomInstance longo_room_title_screen_instances[] = {
    ...
    { LONGO_OBJ_SKULL, 240, 16, 1, 1, -500 },
    { LONGO_OBJ_SKULL, 256, 16, 1, 1, -500 },
    { LONGO_OBJ_SKULL, 272, 16, 1, 1, -500 },
    { LONGO_OBJ_BOX, 32, 128, 1, 1, -500 },
    { LONGO_OBJ_BOX, 16, 112, 1, 1, -500 },
    { LONGO_OBJ_SKULL, 240, 0, 1, 1, -500 },
    { LONGO_OBJ_SKULL, 256, 0, 1, 1, -500 },
    { LONGO_OBJ_SKULL, 272, 0, 1, 1, -500 },
    { LONGO_OBJ_SKULL, 288, 128, 1, 1, -500 },
    { LONGO_OBJ_SKULL, 32, 32, 1, 1, -500 },
...
static const LongoRoom longo_room_title_screen = {
    ...
    longo_room_title_screen_instances,
    (int)(sizeof(longo_room_title_screen_instances) / sizeof(longo_room_title_screen_instances[0]))
};

static const LongoRoomInstance longo_room_tutorial_instances[] = {
    { LONGO_OBJ_DOG, 40, 56, 1, 1, 300 },
    { LONGO_OBJ_FLOWER, 0, 0, 1, 1, 300 },
    { LONGO_OBJ_APPLE, 208, 160, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 96, 160, 1, 1, 300 },
    ...
    { LONGO_OBJ_SKULL, 64, 160, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 80, 144, 1, 1, 300 },
...
static const LongoRoom longo_room_tutorial = {
    "rm_tutorial", 304, 208,
    longo_room_tutorial_instances,
    (int)(sizeof(longo_room_tutorial_instances) / sizeof(longo_room_tutorial_instances[0]))
};

static const LongoRoomInstance longo_room_level6_instances[] = {
...
static const LongoRoom longo_room_level6 = {
    "rm_level6", 304, 208,
    longo_room_level6_instances,
    (int)(sizeof(longo_room_level6_instances) / sizeof(longo_room_level6_instances[0]))
};

static const LongoRoomInstance longo_room_level5_instances[] = {
    ...
    { LONGO_OBJ_SKULL, 208, 128, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 256, 160, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 208, 96, 1, 1, 300 },
...
static const LongoRoom longo_room_level5 = {
    "rm_level5", 304, 208,
    longo_room_level5_instances,
    (int)(sizeof(longo_room_level5_instances) / sizeof(longo_room_level5_instances[0]))
};

static const LongoRoomInstance longo_room_level4_instances[] = {
    { LONGO_OBJ_FLOWER, 0, 224, 1, 1, 100 },
    ...
    { LONGO_OBJ_SKULL, 0, 176, 1, 1, 0 },
    { LONGO_OBJ_SKULL, 16, 192, 1, 1, 0 },
    { LONGO_OBJ_SKULL, 32, 176, 1, 1, 0 },
    { LONGO_OBJ_SKULL, 64, 176, 1, 1, 0 },
    { LONGO_OBJ_SKULL, 80, 192, 1, 1, 0 },
    { LONGO_OBJ_SKULL, 96, 176, 1, 1, 0 },
...
static const LongoRoom longo_room_level4 = {
    "rm_level4", 304, 208,
    longo_room_level4_instances,
    (int)(sizeof(longo_room_level4_instances) / sizeof(longo_room_level4_instances[0]))
};

static const LongoRoomInstance longo_room_level2_instances[] = {
    { LONGO_OBJ_FLOWER, 0, 224, 1, 1, 400 },
    { LONGO_OBJ_DOG, 24, 88, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 64, 80, 1, 1, 300 },
    ...
    { LONGO_OBJ_SKULL, 160, 80, 1, 1, 300 },
    { LONGO_OBJ_BLOCK, 96, 80, 1, 1, 300 },
    { LONGO_OBJ_BUTTON, 96, 64, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 96, 96, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 192, 160, 1, 1, 300 },
...
static const LongoRoom longo_room_level2 = {
    "rm_level2", 304, 208,
    longo_room_level2_instances,
    (int)(sizeof(longo_room_level2_instances) / sizeof(longo_room_level2_instances[0]))
};

static const LongoRoomInstance longo_room_level1_instances[] = {
    { LONGO_OBJ_FLOWER, 0, 224, 1, 1, 400 },
    ...
    { LONGO_OBJ_SKULL, 256, 96, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 240, 96, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 224, 96, 1, 1, 300 },
    ...
    { LONGO_OBJ_SKULL, 224, 64, 1, 1, 300 },
    { LONGO_OBJ_APPLE, 192, 144, 1, 1, 300 },
...
static const LongoRoom longo_room_level1 = {
    "rm_level1", 304, 208,
    longo_room_level1_instances,
    (int)(sizeof(longo_room_level1_instances) / sizeof(longo_room_level1_instances[0]))
};

static const LongoRoomInstance longo_room_level3_instances[] = {
    { LONGO_OBJ_FLOWER, 0, 224, 1, 1, 400 },
    ...
    { LONGO_OBJ_SKULL, 0, 160, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 0, 144, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 0, 128, 1, 1, 300 },
    ...
    { LONGO_OBJ_SKULL, 144, 64, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 160, 80, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 160, 48, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 128, 80, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 128, 48, 1, 1, 300 },
...
static const LongoRoom longo_room_level3 = {
    "rm_level3", 304, 208,
    longo_room_level3_instances,
    (int)(sizeof(longo_room_level3_instances) / sizeof(longo_room_level3_instances[0]))
};

static const LongoRoomInstance longo_room_credits_instances[] = {
    { LONGO_OBJ_FLOWER, 0, 224, 1, 1, 100 },
    ...
    { LONGO_OBJ_BLOCK, -16, -16, 1, 15, 0 },
    { LONGO_OBJ_SHADOWS, 0, 0, 1, 1, 300 },
    { LONGO_OBJ_SKULL, 224, 96, 1, 1, 0 },
    { LONGO_OBJ_SKULL, 64, 48, 1, 1, 0 },
    { LONGO_OBJ_SKULL, 48, 160, 1, 1, 0 },
    ...
    { LONGO_OBJ_SKULL, 192, 192, 1, 1, 0 },
    { LONGO_OBJ_SKULL, 176, 192, 1, 1, 0 },
...
static const LongoRoom longo_room_credits = {
    "rm_credits", 304, 208,
    longo_room_credits_instances,
    (int)(sizeof(longo_room_credits_instances) / sizeof(longo_room_credits_instances[0]))
};

static const LongoRoomInstance longo_room_editor_instances[] = {
...
static const LongoRoom longo_room_editor = {
    "rm_editor", 304, 208,
    longo_room_editor_instances,
    (int)(sizeof(longo_room_editor_instances) / sizeof(longo_room_editor_instances[0]))
};

static const LongoRoomInstance longo_room_levelbase_instances[] = {
    { LONGO_OBJ_FLOWER, 0, 224, 1, 1, 100 },
    { LONGO_OBJ_DOG, 24, 88, 1, 1, 0 },
    { LONGO_OBJ_BLOCK, 304, -16, 1, 15, 0 },
    { LONGO_OBJ_BLOCK, -16, -16, 21, 1, 0 },
...
static const LongoRoom longo_room_levelbase = {
    ...
    longo_room_levelbase_instances,
    (int)(sizeof(longo_room_levelbase_instances) / sizeof(longo_room_levelbase_instances[0]))
};

/* Runtime room table: index 0 is the GameMaker start room; room_goto_next()
 * walks this array.  oTransition.object_num starts at 1 on the title room. */
